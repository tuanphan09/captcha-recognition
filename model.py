...
def CRNN_v1_model(is_training=True):
    ...
    conv_3 = Conv2D(64, (3, 3), activation='relu', padding='same')(drop_2)
    ...
    drop_4 = Dropout(0.15)(pool_2)

    conv_5 = Conv2D(128, (3, 3), activation='relu', padding='same')(drop_4)
    conv_6 = Conv2D(128, (3, 3), activation='relu', padding='same')(conv_5)
    batchnorm_6 = BatchNormalization()(conv_6)

    bn_shape = batchnorm_6.get_shape()  # (?, {dimension}50, {dimension}12, {dimension}256)
    ...
    fc_1 = Dense(128, activation='relu')(drop_reshape)  # (?, 50, 128)
